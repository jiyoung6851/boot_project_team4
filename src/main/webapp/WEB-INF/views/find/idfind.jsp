    ...
    <body>
        <div class="container">
            <div class="header-container">
                <div class="btn-group">
                    <button type="button" id="generalBtn" class="form-button active" data-form="generalForm" onclick="geloform()">일반회원 아이디 찾기</button>
                    <button type="button" id="businessBtn" class="form-button" data-form="businessForm" onclick="buloform()">기업회원 아이디 찾기 </button>
                </div>
            </div>
...
<!--				 이메일 인증 -->
	               <div class="form-group">
	                  	기업회원 이메일<input type="text" id="cmail" name="cmail" placeholder="Email을 입력해주세요" style="width: 73%;">
	                   <div class="validation-message"></div>
	                   <span>
