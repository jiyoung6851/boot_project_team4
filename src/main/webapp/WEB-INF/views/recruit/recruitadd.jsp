                ...
                <div class="infoTbBx">
					<div class="tbRow">
						<div class="tbCell">
							<div class="elWrap">
								<div class="schInpType">
									<input type="text" class="inpDefault" id="jobtitle" name="jobtitle" value="${recruitlist.jobtitle}" maxlength="50" placeholder=" ">
						...
						<div class="tbCell">
							<div class="elWrap">
								<div class="schInpType">
									<input type="text" class="inpDefault" id="jobsubtitle" name="jobsubtitle" value="${recruitlist.jobsubtitle}" maxlength="100" placeholder=" ">
						...
						<div class="tbCell">
							<div class="elWrap">
								<div class="schInpType">
									<input type="text" class="inpDefault" id="content" name="content" value="${recruitlist.content}" maxlength="500" placeholder=" ">
			...
			<div class="infoTbBx">
				<div class="tbRow">
					<div class="tbCell">
						<div class="elWrap">
							<div class="schInpType">
								<input type="text" class="inpDefault has-placeholder" id="position" name="position" value="${recruitlist.position}" maxlength="50" placeholder="최대한 직무명을 포함하여 입력하세요. ex) 웹프로그래머, 아트디렉터, java개발 등">
					...
					<div class="tbCell2">
						<div class="elWrap">
							<div class="schInpType">
								<input type="text" class="inpDefault" id="duties" name="duties" value="${recruitlist.duties}" maxlength="50" placeholder=" ">
					...
					<div class="tbCell2">
						<div class="elWrap">
							<div class="schInpType">
								<input type="text" class="inpDefault" id="pfntcd" name="pfntcd" value="${recruitlist.pfntcd}" maxlength="50" placeholder=" ">
			...
			<div class="infoTbBx">
				<div class="tbRow">
						    ...
						    <div class="elWrap">
						        <div class="schInpType">
						            <input type="text" class="inpDefault has-placeholder" id="salary" name="salary" 
						                   value="${recruitlist.salary == 0 ? '':recruitlist.salary}" 
					...
					<div class="tbCell2">
						<div class="elWrap">
							<div class="schInpType">
								<input type="text" class="inpDefault" id="loc01" name="loc01" value="${recruitlist.loc01}" maxlength="50" placeholder=" ">
					...
					<div class="tbCell2">
						<div class="elWrap">
							<div class="schInpType">
								<input type="text" class="inpDefault" id="wrktm" name="wrktm" value="${recruitlist.wrktm}" maxlength="50" placeholder=" ">
			...
			<div class="infoTbBx">
				<div class="tbRow">
					<div class="tbCell">
						<div class="elWrap">
							<div class="schInpType">
								<input type="text" class="inpDefault" id="benefits" name="benefits" value="${recruitlist.benefits}" maxlength="50" placeholder=" ">
			...
			<div class="infoTbBx">
				<div class="tbRow">
					...
					<div class="tbCell2">
						<div class="elWrap">
							<div class="schInpType">
								<input type="text" class="inpDefault" id="recno" name="recno" value="${recruitlist.recno}" maxlength="50" placeholder=" ">
					...
					<div class="tbCell2">
						<div class="elWrap">
							<div class="schInpType">
								<input type="text" class="inpDefault" id="rcmpcd" name="rcmpcd" value="${recruitlist.rcmpcd}" maxlength="50" placeholder=" ">
