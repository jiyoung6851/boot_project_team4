...
<div class="container" >
    <div class="header-container">
        <div class="btn-group">
            <button type="button" id="businessBtn" class="form-button active" data-form="businessForm" onclick="buloform()">기업회원 비밀번호 변경</button>
			</div>
		</div>
	...
	<h2>기업회원 비밀번호 수정</h2>
		  ...
		  <label for="cpass">새 비밀번호:</label>
	      <input type="password" id="cpass" name="cpass" placeholder="새 비밀전호를 입력해주세요" required>
		  
	      <label for="cconfirmNewPw">새 비밀번호 확인: </label>
	      <input type="password" id="cconfirmNewPw" name="cconfirmNewPw" placeholder="비밀번호를 한번 더 입력해주세요" required>
