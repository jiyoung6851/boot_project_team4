$(document).ready(function() {
    ...
    function addAnotherMajor() {
        $anotherMajorBtn.text('다른 전공 -');
        $('#anotherMajorDiv').show();
    }

    function removeAnotherMajor() {
        $anotherMajorBtn.text('다른 전공 +');
        $('#anotherMajorDiv').hide();
    }

    function addGraduationWork() {
        $graduationWorkBtn.text('졸업 논문/작품 -');
        $('#graduationWorkDiv').show();
    }

    function removeGraduationWork() {
        $graduationWorkBtn.text(' 졸업 논문/작품 +');
        $('#graduationWorkDiv').hide();
    }
});
